...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'ptrm-reporting-manager', data: { breadcrumb: 'Table' }, loadChildren: () => import('./ptrm-reporting-manager/tabledemo.module').then(m => m.TableDemoModule) },
        { path: 'ptrm-limit-monitoring', data: { breadcrumb: 'Tree' }, loadChildren: () => import('./ptrm-limit-monitoring/treedemo.module').then(m => m.TreeDemoModule) },
        { path: 'ptrm-concetration-monitoring', data: { breadcrumb: 'Tree' }, loadChildren: () => import('./ptrm-limit-monitoring/treedemo.module').then(m => m.TreeDemoModule) },
        { path: 'ptrm-analytics', data: { breadcrumb: 'Tree' }, loadChildren: () => import('./ptrm-analytics/inputdemo.module').then(m => m.InputDemoModule) },
        { path: 'ptrm-admin', data: { breadcrumb: 'Tree' }, loadChildren: () => import('./ptrm-admin/inputdemo.module').then(m => m.InputDemoModule) },
