...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'table-ptrm', data: { breadcrumb: 'Table' }, loadChildren: () => import('./table-ptrm/tabledemo.module').then(m => m.TableDemoModule) },
        { path: 'tree', data: { breadcrumb: 'Tree' }, loadChildren: () => import('./tree/treedemo.module').then(m => m.TreeDemoModule) },
        { path: 'tree-ptrm', data: { breadcrumb: 'Tree' }, loadChildren: () => import('./tree-ptrm/treedemo.module').then(m => m.TreeDemoModule) },
